...
public class HttpFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    protected void messageReceived(ChannelHandlerContext ctx, FullHttpRequest request) throws Exception {
        ...
        ctx.write(response);
        ChannelFuture sendFielFuture;
        sendFielFuture = ctx.write(new ChunkedFile(randomAccessFile, 0, fileLength, 8192), ctx.newProgressivePromise());
        sendFielFuture.addListener(new ChannelProgressiveFutureListener() {
            @Override
